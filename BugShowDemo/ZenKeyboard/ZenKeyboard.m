...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {        
        ...
        keyboardShadow.frame = CGRectMake(0, 0, CGRectGetMaxX(frame), 17);
...
- (UIButton *)addBackspaceKeyWithFrame:(CGRect)frame {
    ...
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake((KEYBOARD_NUMERIC_KEY_WIDTH - image.size.width) / 2, (KEYBOARD_NUMERIC_KEY_HEIGHT - image.size.height) / 2, image.size.width, image.size.height)];
    imgView.image = image;
